...
class Rig_Menu(object):
    ...
    def adv_menu(self, p_menu):
        pm.menuItem(to=True, p=p_menu, i='AS5_tool.png', l='ADV辅助工具', c="from tool_ui import advTools;"
                                                                           "reload(advTools);"
    ...
    def tool_menu(self, p_menu):
        ...
        pm.menuItem(to=True, p=p_menu, l=u'Meta调教器', i='MS_Logo.png', c='from tool_ui import MeTa_Training_win;'
        ...
        pm.menuItem(to=True, p=p_menu, i='studio_library.png', l='打开studio_library', c='import reload_tools;'
    ...
    def set_wps(self, p_menu):
        ...
        pm.menuItem(to=True, p=p_menu, l='打开FBX记录表', i='excel.png',
                    c='os.startfile("X:/Project/XXTT/山魈动画-表格文档/《XXTT》/资产-UE沟通对接/资产SVN-FBX记录表.xlsx")')
        pm.menuItem(to=True, p=p_menu, l='打开XXTT资产制作表', i='excel.png',
                    c='os.startfile("X:/Project/XXTT/山魈动画-表格文档/《XXTT》/资产-UE沟通对接/时间资产制作表.xlsx")')
