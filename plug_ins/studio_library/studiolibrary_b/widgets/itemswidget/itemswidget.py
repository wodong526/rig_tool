...
class ItemsWidget(QtWidgets.QWidget):
    ...
    def createSettingsMenu(self):
        ...
        menu = QtWidgets.QMenu(u"项目视图", self)

        action = SeparatorAction(u"视图设置", menu)
        menu.addAction(action)

        action = SliderAction(u"大小", menu)
        ...
        action = SeparatorAction(u"标签选项", menu)
        menu.addAction(action)
