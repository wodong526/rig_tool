...
class LibraryWindow(QtWidgets.QWidget):
    ...
    def _foldersMenuRequested(self, menu):
        ...
        """
        action = QtWidgets.QAction(u"更改路径", menu)
    ...
    def showFilterByMenu(self):
        ...
        :rtype: None
        """
        widget = self.menuBarWidget().findToolButton(u"过滤器")
    ...
    def showGroupByMenu(self):
        ...
        :rtype: None
        """
        widget = self.menuBarWidget().findToolButton(u"分组依据")
        point = widget.mapToGlobal(QtCore.QPoint(0, widget.height()))
    ...
    def showSortByMenu(self):
        ...
        :rtype: None
        """
        widget = self.menuBarWidget().findToolButton(u"排序依据")
        point = widget.mapToGlobal(QtCore.QPoint(0, widget.height()))
    ...
    def showItemViewMenu(self):
        ...
        widget = self.menuBarWidget().findToolButton(u"项目视图")
    ...
    def createSettingsMenu(self):
        ...
        action = menu.addAction(u"同步")
        action.triggered.connect(self.sync)

        menu.addSeparator()
        action = menu.addAction(u"设置")
        ...
        if self.trashEnabled():
            action = QtWidgets.QAction(u"显示垃圾箱文件夹", menu)
        ...
        action = QtWidgets.QAction(u"启用递归搜索", menu)
        action.setCheckable(True)
    ...
    def updateCreateItemButton(self):
        ...
        :rtype: None
        """
        action = self.menuBarWidget().findAction(u"新建项目")
    ...
    def updateViewButton(self):
        ...
        """
        compact = self.isCompactView()
        action = self.menuBarWidget().findAction(u"视图")
    ...
    def updateFiltersButton(self):
        ...
        action = self.menuBarWidget().findAction(u"过滤器")
