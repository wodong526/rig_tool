...
class SidebarWidget(QtWidgets.QWidget):
    ...
    def createSettingsMenu(self, menu):
        ...
        action = menu.addAction(u"显示根文件夹")
        action.setCheckable(True)
