...
def connectExpression(driverCtrl, driverAttr, minVal, maxVal, driverKey1, driverKey2, expCtrl, expAttr, expKey1,
    ...
    if pycore.objExists(expCtrl + "." + expAttr):
...
def connectAllExpressions():
    # brows down
    MayaUtil.logger.info("Connecting brows down")
    ...
    # brows lateral
    MayaUtil.logger.info("Connecting brows lateral")
    ...
    # brows raise
    MayaUtil.logger.info("Connecting brows raise")
    ...
    # ears up
    MayaUtil.logger.info("Connecting ears up")
    ...
    # eyes widen/blink
    MayaUtil.logger.info("Connecting eyes widen/blink")
    ...
    # lid press
    MayaUtil.logger.info("Connecting lid press")
    ...
    # eyes squint inner
    MayaUtil.logger.info("eyes squint inner")
    ...
    connectExpression("CTRL_R_eye_squintInner", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "eyeSquintInnerR", 0.0,
                      1.0)
    # eyes cheek raise
    MayaUtil.logger.info("Connecting cheek raise")
    ...
    # face scrunch
    MayaUtil.logger.info("Connecting face crunch")
    ...
    MayaUtil.logger.info("Connecting eyelids up/down (and eyes relax)")
    ...
    MayaUtil.logger.info("Connecting eyes look up/down/left/right")
    ...
    # pupils wide/narrow
    MayaUtil.logger.info("Connecting pupils wide/narrow")
    ...
    MayaUtil.logger.info("Connecting nose wrinkle/depress/dilate/compress")
    ...
    # nose wrinkle upper
    MayaUtil.logger.info("Connecting nose wrinkle upper")
    ...
    connectExpression("CTRL_R_nose_wrinkleUpper", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "noseWrinkleUpperR",
                      0.0, 1.0)
    # nasolabial deepener
    MayaUtil.logger.info("Connecting nasolabial deepener")
    ...
    # cheek suck/blow
    MayaUtil.logger.info("Connecting cheek suck/blow")
    ...
    connectExpression("CTRL_R_mouth_suckBlow", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "mouthCheekSuckR", 0.0,
                      1.0)
    # lips blow
    MayaUtil.logger.info("Connecting lips blow")
    ...
    MayaUtil.logger.info("Connecting mouth up/down/left/right")
    ...
    # upper lip raise
    MayaUtil.logger.info("Connecting upper lip raise")
    ...
    connectExpression("CTRL_R_mouth_upperLipRaise", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthUpperLipRaiseR",
                      0.0, 1.0)
    # lower lip depress
    MayaUtil.logger.info("Connecting lower lip depress")
    ...
    # corner pull
    MayaUtil.logger.info("Connecting corner pull")
    ...
    connectExpression("CTRL_R_mouth_cornerPull", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthCornerPullR", 0.0,
                      1.0)
    # mouth stretch
    MayaUtil.logger.info("Connecting mouth stretch")
    ...
    MayaUtil.logger.info("Connecting mouth stretch lips close")
    ...
    # dimpler
    MayaUtil.logger.info("Connecting dimpler")
    ...
    # corner depress
    MayaUtil.logger.info("Connecting corner depress")
    ...
    connectExpression("CTRL_R_mouth_cornerDepress", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthCornerDepressR",
                      0.0, 1.0)
    # mouth press
    MayaUtil.logger.info("Connecting mouth press")
    ...
    # purse
    MayaUtil.logger.info("Connecting purse")
    ...
    # lips towards
    MayaUtil.logger.info("Connecting lips towards")
    ...
    connectExpression("CTRL_R_mouth_towardsD", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthLipsTowardsDR", 0.0,
                      1.0)
    # funnel
    MayaUtil.logger.info("Connecting funnel")
    ...
    # lips together
    MayaUtil.logger.info("Connecting lips together")
    ...
    connectExpression("CTRL_R_mouth_lipsTogetherD", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthLipsTogetherDR",
                      0.0, 1.0)
    # upper lip bite
    MayaUtil.logger.info("Connecting upper lip bite")
    ...
    connectExpression("CTRL_R_mouth_lipBiteU", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthUpperLipBiteR", 0.0,
                      1.0)
    # lower lip bite
    MayaUtil.logger.info("Connecting lower lip bite")
    ...
    connectExpression("CTRL_R_mouth_lipBiteD", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthLowerLipBiteR", 0.0,
                      1.0)
    # lips tighten
    MayaUtil.logger.info("Connecting lips tighten")
    ...
    connectExpression("CTRL_R_mouth_tightenD", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthLipsTightenDR", 0.0,
                      1.0)
    # lips press
    MayaUtil.logger.info("Connecting lips press")
    ...
    connectExpression("CTRL_R_mouth_lipsPressU", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthLipsPressR", 0.0,
                      1.0)
    # sharp corner pull
    MayaUtil.logger.info("Connecting sharp corner pull")
    ...
    # mouth sticky
    MayaUtil.logger.info("Connecting mouth sticky")
    ...
    connectExpression("CTRL_R_mouth_stickyOuterD", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "mouthStickyDOUTR",
                      0.0, 1.0)
    # sticky lips
    MayaUtil.logger.info("Connecting sticky lips")
    ...
    # lips push/pull
    MayaUtil.logger.info("Connecting lips push/pull")
    ...
    connectExpression("CTRL_R_mouth_pushPullD", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "mouthLipsPullDR", 0.0,
                      1.0)
    # lips thin/thick
    MayaUtil.logger.info("Connecting lips thin/thick")
    ...
    MayaUtil.logger.info("Connecting lips thin/thick inward")
    connectExpression("CTRL_L_mouth_thicknessInwardU", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions",
                      "mouthLipsThinInwardUL", 0.0, 1.0)
    connectExpression("CTRL_R_mouth_thicknessInwardU", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions",
                      "mouthLipsThinInwardUR", 0.0, 1.0)
    connectExpression("CTRL_L_mouth_thicknessInwardD", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions",
                      "mouthLipsThinInwardDL", 0.0, 1.0)
    connectExpression("CTRL_R_mouth_thicknessInwardD", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions",
    ...
    # corner sharpen
    MayaUtil.logger.info("Connecting corner sharpen")
    ...
    # lips shift
    MayaUtil.logger.info("Connecting lips shift")
    ...
    # lips roll
    MayaUtil.logger.info("Connecting lips roll")
    ...
    connectExpression("CTRL_R_mouth_lipsRollD", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "mouthLowerLipRollOutR",
                      0.0, 1.0)
    # corners
    MayaUtil.logger.info("Connecting corners")
    ...
    MayaUtil.logger.info("Connecting tongue move up/down/left/right")
    connectExpression("CTRL_C_tongue_move", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueUp", 0.0, 1.0)
    connectExpression("CTRL_C_tongue_move", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueDown", 0.0, 1.0)
    connectExpression("CTRL_C_tongue_move", "tx", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueLeft", 0.0, 1.0)
    connectExpression("CTRL_C_tongue_move", "tx", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueRight", 0.0, 1.0)
    # tongue in/out
    MayaUtil.logger.info("Connecting tongue in/out")
    ...
    MayaUtil.logger.info("Connecting tongue bend up/down and twist left/right")
    connectExpression("CTRL_C_tongue_bendTwist", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueBendUp", 0.0,
                      1.0)
    connectExpression("CTRL_C_tongue_bendTwist", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueBendDown", 0.0,
                      1.0)
    connectExpression("CTRL_C_tongue_bendTwist", "tx", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueTwistLeft", 0.0,
                      1.0)
    connectExpression("CTRL_C_tongue_bendTwist", "tx", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueTwistRight",
                      0.0, 1.0)
    # tongue tip move up/down/left/right
    MayaUtil.logger.info("Connecting tongue tip move up/down/left/right")
    connectExpression("CTRL_C_tongue_tipMove", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueTipUp", 0.0, 1.0)
    connectExpression("CTRL_C_tongue_tipMove", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueTipDown", 0.0,
                      1.0)
    connectExpression("CTRL_C_tongue_tipMove", "tx", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueTipLeft", 0.0, 1.0)
    connectExpression("CTRL_C_tongue_tipMove", "tx", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueTipRight", 0.0,
                      1.0)
    # tongue wide/narrow
    MayaUtil.logger.info("Connecting tongue wide/narrow")
    connectExpression("CTRL_C_tongue_wideNarrow", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueWide", 0.0, 1.0)
    connectExpression("CTRL_C_tongue_wideNarrow", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueNarrow", 0.0,
                      1.0)
    # tongue press
    MayaUtil.logger.info("Connecting tongue press")
    connectExpression("CTRL_C_tongue_press", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tonguePress", 0.0, 1.0)
    # tongue roll
    MayaUtil.logger.info("Connecting tongue roll")
    connectExpression("CTRL_C_tongue_roll", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueRoll", 0.0, 1.0)
    # tongue thick/thin
    MayaUtil.logger.info("Connecting tongue thick/thin")
    connectExpression("CTRL_C_tongue_thickThin", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueThick", 0.0, 1.0)
    connectExpression("CTRL_C_tongue_thickThin", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueThin", 0.0, 1.0)

    # jaw open
    MayaUtil.logger.info("Connecting jaw open")
    connectExpression("CTRL_C_jaw", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "jawOpen", 0.0, 1.0)
    # jaw left/right
    MayaUtil.logger.info("Connecting jaw left/right")
    ...
    # jaw back/fwd
    MayaUtil.logger.info("Connecting jaw back/fwd")
    ...
    # jaw clench
    MayaUtil.logger.info("Connecting jaw clench")
    ...
    # chin raise
    MayaUtil.logger.info("Connecting chin raise")
    ...
    # chin compress
    MayaUtil.logger.info("Connecting chin compress")
    ...
    # swallow
    MayaUtil.logger.info("Connecting swallow")
    ...
    # mastoid contract
    MayaUtil.logger.info("Connecting mastoid contract")
    ...
    # throat down/up
    MayaUtil.logger.info("Connecting throat down/up")
    ...
    # digastric down/up
    MayaUtil.logger.info("Connecting digastric down/up")
    ...
    connectExpression("CTRL_neck_digastricUpDown", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "neckDigastricUp",
                      0.0, 1.0)
    # exale/inhale
    MayaUtil.logger.info("Connecting exale/inhale")
    ...
    # upper teeth
    MayaUtil.logger.info("Connecting upper teeth")
    ...
    # lower teeth
    MayaUtil.logger.info("Connecting lower teeth")
    ...
    # look at switch
    MayaUtil.logger.info("Connecting look at switch")
    ...
    MayaUtil.logger.info("Connecting DONE!")
...
def cleanUp():
    ...
    for joint in body_joints:
        mel.eval("CBdeleteConnection " + joint + ".sx;")
        mel.eval("CBdeleteConnection " + joint + ".sy;")
        mel.eval("CBdeleteConnection " + joint + ".sz;")
        mel.eval("CBdeleteConnection " + joint + ".tx;")
        mel.eval("CBdeleteConnection " + joint + ".ty;")
        mel.eval("CBdeleteConnection " + joint + ".tz;")
        mel.eval("CBdeleteConnection " + joint + ".rx;")
        mel.eval("CBdeleteConnection " + joint + ".ry;")
        mel.eval("CBdeleteConnection " + joint + ".rz;")
...
def connectNeckCorrectives():
    ...
    if pycore.objExists("head.matrix") and pycore.objExists("head_RBFdecomposeMatrix.inputMatrix"):
        pycore.connectAttr("head.matrix", "head_RBFdecomposeMatrix.inputMatrix")

    if pycore.objExists("neck_02.matrix") and pycore.objExists("neck_02_RBFdecomposeMatrix.inputMatrix"):
        pycore.connectAttr("neck_02.matrix", "neck_02_RBFdecomposeMatrix.inputMatrix")

    if pycore.objExists("neck_01.matrix") and pycore.objExists("neck_01_RBFdecomposeMatrix.inputMatrix"):
        pycore.connectAttr("neck_01.matrix", "neck_01_RBFdecomposeMatrix.inputMatrix")

    # connect joints rotations (without JO) with setup
    if pycore.objExists("head.rx") and pycore.objExists("head_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dx"):
        pycore.connectAttr("head.rx", "head_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dx")

    if pycore.objExists("head.ry") and pycore.objExists("head_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dy"):
        pycore.connectAttr("head.ry", "head_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dy")

    if pycore.objExists("head.rz") and pycore.objExists("head_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dz"):
        pycore.connectAttr("head.rz", "head_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dz")

    if pycore.objExists("neck_02.rx") and pycore.objExists(
            "neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dx"):
        pycore.connectAttr("neck_02.rx", "neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dx")

    if pycore.objExists("neck_02.ry") and pycore.objExists(
            "neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dy"):
        pycore.connectAttr("neck_02.ry", "neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dy")

    if pycore.objExists("neck_02.rz") and pycore.objExists(
            "neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dz"):
        pycore.connectAttr("neck_02.rz", "neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dz")

    if pycore.objExists("neck_01.rx") and pycore.objExists(
            "neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dx"):
        pycore.connectAttr("neck_01.rx", "neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dx")

    if pycore.objExists("neck_01.ry") and pycore.objExists(
            "neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dy"):
        pycore.connectAttr("neck_01.ry", "neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dy")

    if pycore.objExists("neck_01.rz") and pycore.objExists(
            "neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dz"):
        pycore.connectAttr("neck_01.rz", "neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dz")

    # updating values for zero outing
    head_tx = pycore.getAttr("head.tx")
    pycore.setAttr("head_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", head_tx)
    head_ty = pycore.getAttr("head.ty")
    pycore.setAttr("head_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", head_ty)
    head_tz = pycore.getAttr("head.tz")
    pycore.setAttr("head_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", head_tz)
    head_rx = pycore.getAttr("head.rx")
    pycore.setAttr("head_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", head_rx)
    head_ry = pycore.getAttr("head.ry")
    pycore.setAttr("head_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", head_ry)
    head_rz = pycore.getAttr("head.rz")
    pycore.setAttr("head_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", head_rz)
    neck_02_tx = pycore.getAttr("neck_02.tx")
    pycore.setAttr("neck_02_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", neck_02_tx)
    neck_02_ty = pycore.getAttr("neck_02.ty")
    pycore.setAttr("neck_02_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", neck_02_ty)
    neck_02_tz = pycore.getAttr("neck_02.tz")
    pycore.setAttr("neck_02_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", neck_02_tz)
    neck_02_rx = pycore.getAttr("neck_02.rx")
    pycore.setAttr("neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", neck_02_rx)
    neck_02_ry = pycore.getAttr("neck_02.ry")
    pycore.setAttr("neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", neck_02_ry)
    neck_02_rz = pycore.getAttr("neck_02.rz")
    pycore.setAttr("neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", neck_02_rz)
    neck_01_tx = pycore.getAttr("neck_01.tx")
    pycore.setAttr("neck_01_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", neck_01_tx)
    neck_01_ty = pycore.getAttr("neck_01.ty")
    pycore.setAttr("neck_01_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", neck_01_ty)
    neck_01_tz = pycore.getAttr("neck_01.tz")
    pycore.setAttr("neck_01_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", neck_01_tz)
    neck_01_rx = pycore.getAttr("neck_01.rx")
    pycore.setAttr("neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", neck_01_rx)
    neck_01_ry = pycore.getAttr("neck_01.ry")
    pycore.setAttr("neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", neck_01_ry)
    neck_01_rz = pycore.getAttr("neck_01.rz")
    pycore.setAttr("neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", neck_01_rz)
    ...
    pycore.setAttr("GRP_neckSetupGUI.visibility", 0)
